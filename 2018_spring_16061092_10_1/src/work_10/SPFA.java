...
public class SPFA extends Thread{
	/** 
     * @Overview:更新map，基于新map寻找最短路径，每500s更新流量。
     */
    ...
    public static int[] liu_ri = new int[10000];//用于记录该点与其右边点的流量
    public static int[] liu_do = new int[10000];//用于记录该点与其下边点的流量
